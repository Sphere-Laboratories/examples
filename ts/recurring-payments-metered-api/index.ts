...
(async () => {
      ...
      const freePlan: Price = await sphere.price.create({
            name: 'Free Plan',
            description:
                  'Ideally suited for prototyping and low-volume use-cases.',
            currency,
            mutable: true,
            meta: {
                  uuid: 'HELIUS_IFQKFG',
      ...
      const developerPlan: Price = await sphere.price.create({
            name: 'Developer Plan',
            description:
                  `Perfect for individual developers, side projects and hackathons. 
      ...
      const businessPlan: Price = await sphere.price.create({
            name: 'Business Plan',
            description:
                  `Great for businesses, startups, and advanced developers. 
